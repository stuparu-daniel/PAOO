...
namespace paoo {
    ...
    ComplexNumber & ComplexNumber::operator=(const ComplexNumber &other) {
        std::cout << "ComplexNumber assigned" << std::endl;
        double *originalReal = this->real;
        double *origninalImaginary = this->imaginary;
        this->real = new double(*other.real);
        this->imaginary = new double(*other.imaginary);
        delete originalReal;
        delete origninalImaginary;
